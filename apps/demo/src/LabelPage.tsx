...
function toJsxMarkup(html: string): string {
  return daisyToJsx(html)
    ...
    .replace(
      /<(input|select|textarea)\b([^>]*?)\svalue=/g,
      '<$1$2 defaultValue=',
    )
}
...
function codeLabel(value: string): string {
  return `<code class="font-mono text-[0.65rem] text-ink-muted">${value}</code>`
}
...
const helperHtml = `<div class="grid max-w-lg gap-6">
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('label + label-text + p.label helper')}
  </div>
  ...
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('input + span.label prefix')}
  </div>
  ...
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('input + span.label suffix')}
  </div>
  ...
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('select + span.label')}
  </div>
</div>`

const requiredHtml = `<div class="grid max-w-md gap-4">
  <div class="flex flex-col gap-2">
    ...
    <input
      ...
      required />
    ${codeLabel('label + text-error * + required')}
  </div>
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('label (optional, no asterisk)')}
  </div>
</div>`

const floatingHtml = `<div class="grid max-w-lg gap-4">
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('floating-label + input')}
  </div>
  ...
  <div class="flex flex-col gap-2">
    ...
    ${codeLabel('floating-label + required *')}
  </div>
    ...
    <div class="flex flex-col gap-1">
      <label class="floating-label">
        <input
          type="text"
          placeholder="XS"
          class="input input-primary w-full cursor-text input-xs" />
        <span>XS</span>
      </label>
      ${codeLabel('floating-label + input input-xs')}
    </div>
    <div class="flex flex-col gap-1">
      <label class="floating-label">
        <input
          type="text"
          placeholder="SM"
          class="input input-primary w-full cursor-text input-sm" />
        <span>SM</span>
      </label>
      ${codeLabel('floating-label + input input-sm')}
    </div>
    <div class="flex flex-col gap-1">
      <label class="floating-label">
        <input
          type="text"
          placeholder="MD"
          class="input input-primary w-full cursor-text input-md" />
        <span>MD</span>
      </label>
      ${codeLabel('floating-label + input input-md')}
    </div>
    <div class="flex flex-col gap-1">
      <label class="floating-label">
        <input
          type="text"
          placeholder="LG"
          class="input input-primary w-full cursor-text input-lg" />
        <span>LG</span>
      </label>
      ${codeLabel('floating-label + input input-lg')}
    </div>
    <div class="flex flex-col gap-1">
      <label class="floating-label">
        <input
          type="text"
          placeholder="XL"
          class="input input-primary w-full cursor-text input-xl" />
        <span>XL</span>
      </label>
      ${codeLabel('floating-label + input input-xl')}
    </div>
  </div>
</div>`

const controlsHtml = `<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
  <div class="flex flex-col gap-3">
    ...
    ${codeLabel('label + checkbox + label-text')}
  </div>
  ...
  <div class="flex flex-col gap-3">
    ...
    ${codeLabel('label + toggle + label-text')}
  </div>
  ...
  <div class="flex flex-col gap-3">
    ...
    ${codeLabel('label + radio + label-text')}
  </div>
</div>`
...
<p class="mt-3">
  ${codeLabel('card-title text-primary + label + floating-label')}
</p>`
...
const responsiveHtml = `<div class="grid gap-4 md:grid-cols-2">
  <div class="flex flex-col gap-3 rounded-box border border-base-300 bg-base-200 p-4">
    ...
    <label class="floating-label">
      <textarea
        ...
        rows="3"
      >Cool wash over warm underpainting</textarea>
      <span>Notes</span>
    </label>
    ${codeLabel('floating-label + responsive input/textarea sizes')}
  </div>
  ...
  <div class="flex flex-col gap-3 rounded-box border border-ink-border bg-base-100/80 p-4">
    ...
    ${codeLabel('floating-label select + stacked label')}
  </div>
</div>`
    ...
    <>
      <div className="mb-6 soak-in">
        ...
        <p className="mt-2 max-w-2xl text-sm text-ink-muted md:text-base">
          ...
          <span className="font-mono text-xs">floating-label</span> and floating-label for
          naming fields, helpers, and control captions.
        </p>
      </div>
