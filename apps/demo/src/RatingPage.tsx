      ...
      <div className="space-y-6">
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
            ...
            jsx={`<div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="label-ink mb-2">Plate score</p>
              <StarRadios
                name="rating-basic"
          ...
          <div class="mt-6 border-t border-ink-border/60 pt-5">
            ...
            <div class="rating gap-1">
              <input
                type="radio"
                name="rating-hearts"
                class="mask mask-heart cursor-pointer bg-error"
                aria-label="1 heart"
              />
              <input
                type="radio"
                name="rating-hearts"
                class="mask mask-heart cursor-pointer bg-warning"
                aria-label="2 heart"
                checked
              />
              <input
              ...
              <input
                type="radio"
                name="rating-hearts"
                class="mask mask-heart cursor-pointer bg-success"
                aria-label="4 heart"
              />
              <input
                type="radio"
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <span class="badge badge-success badge-outline shrink-0 font-mono">
               / 5
            </span>
          </div>`}
        ...
        >
          <ShowcaseTabs
            ...
            <div class="flex flex-col items-center gap-2 rounded-box border border-ink-border/60 bg-base-200/30 px-5 py-4">
              <Star class="size-8 text-secondary" strokeWidth= />
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="mb-5 flex flex-wrap items-center gap-2">
            <Palette class="size-4 text-primary" strokeWidth= />
          ...
          <div class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div class="flex flex-col justify-between gap-4 rounded-box border border-ink-border/70 bg-base-100/60 p-4">
              <div>
                ...
                <ul class="space-y-1.5 text-sm text-ink-muted">
                  <li>
                    Critique:
                    <span class="text-base-content"> / 5</span>
                  </li>
                  <li>
                    Pigment:
            ...
            jsx={`<div className="mb-5 flex flex-wrap items-center gap-2">
            <Palette className="size-4 text-primary" strokeWidth={1.75} />
            <p className="text-sm font-medium">Active plate review</p>
          </div>
        ...
        >
          <ShowcaseTabs
            ...
            <div>
              ...
              <ReadOnlyStars value= sizeClass="rating-md" bgClass="bg-warning" />
              <p class="mt-2">
        ...
        >
          <ShowcaseTabs
            ...
            ,
              ...
              <div
                key=
                class="rounded-box border border-ink-border/60 bg-base-100/50 p-4"
              >
                <p class="label-ink mb-3"></p>
                <ReadOnlyStars
                  value=
                  sizeClass="rating-md"
                  bgClass=
