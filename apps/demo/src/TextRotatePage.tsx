...
const basicHtml = `<p class="font-display text-3xl font-semibold tracking-tight md:text-4xl">
...
const variantsHtml = `<div class="grid gap-8 lg:grid-cols-2">
  ...
  <p class="text-base md:text-lg">
    ...
    <span class="text-rotate">
      <span>
        <span class="rounded-field bg-wash-blue px-2 text-base-content">fog</span>
        <span class="rounded-field bg-wash-rose px-2 text-base-content">bloom</span>
        <span class="rounded-field bg-wash-ochre px-2 text-base-content">grain</span>
      </span>
    </span>
  </p>
...
const sizesColorsHtml = `<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
...
const studioHtml = `<div class="rounded-box bg-base-200/70 px-5 py-10 text-center md:px-10 md:py-14">
  ...
  <p class="mx-auto mt-4 max-w-lg text-sm text-ink-muted md:text-base">
    One rotating verb keeps the headline calm while the pigment desk cycles studio language.
  </p>
</div>`

const responsiveHtml = `<span class="text-rotate max-md:text-2xl text-6xl font-display font-semibold">
  <span class="justify-items-center">
    <span>Plate</span>
    <span>Series</span>
    <span>Study</span>
...
const reducedMotionHtml = `<div class="grid gap-6 md:grid-cols-2">
  <div class="flex flex-col gap-2">
    <p class="text-sm text-ink-muted">Live rotator. Flattens automatically when the OS asks for reduced motion.</p>
  ...
  <div class="flex flex-col gap-2">
    <p class="text-sm text-ink-muted">Always flat companion: first word only, no loop.</p>
...
<div class="alert mt-6 text-sm">
  <span>Official daisyUI still ships a stepped fallback under reduced motion. This gallery overrides that with pause and flatten so the headline stays still.</span>
</div>`
      ...
      <div className="space-y-6">
        ...
        >
          <ShowcaseTabs
            ...
            jsx={daisyToJsx(sizesColorsHtml)}
          />
        </Section>
        ...
        >
          <ShowcaseTabs
            ...
            html={reducedMotionHtml}
            jsx={daisyToJsx(reducedMotionHtml)}
          />
        </Section>
      </div>
    </>
