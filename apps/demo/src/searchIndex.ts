...
const extraKeywords: Partial<Record<AppPage, string[]>> = {
  ...
  'charts-realtime': ['realtime chart', 'live chart', 'streaming', 'dynamic animation', 'wash chart'],
  'charts-line': ['line chart', 'area chart', 'missing values', 'null gaps', 'gradient line chart', 'stepline chart', 'trend', 'wash chart', 'time series'],
