...
const basicHtml = `<div class="hero min-h-72 rounded-box bg-base-200">
...
const figureHtml = `<div class="hero min-h-72 rounded-box bg-base-200">
...
const reverseHtml = `<div class="hero min-h-72 rounded-box bg-base-200">
...
const overlayHtml = `<div class="hero min-h-80 rounded-box" style="background-image: linear-gradient(135deg, color-mix(in oklab, var(--wash-a) 88%, transparent), color-mix(in oklab, var(--wash-c) 72%, transparent) 55%, color-mix(in oklab, var(--wash-b) 80%, transparent));">
...
const heightsHtml = `<div class="grid gap-6 lg:grid-cols-2">
...
const heightsJsx = `<div className="grid gap-6 lg:grid-cols-2">
...
const brandHtml = `<div class="hero min-h-80 overflow-hidden rounded-box page-wash">
...
const responsiveHtml = `<div class="hero min-h-72 rounded-box bg-base-200">
      ...
      <div className="space-y-6">
        ...
        >
          <ShowcaseTabs
            ...
            html={figureHtml}
            jsx={daisyToJsx(figureHtml).replace(
              'width="343" height="361"',
              'width={343} height={361}',
            )}
          />
        </Section>
