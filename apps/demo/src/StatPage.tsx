      ...
      <div className="space-y-6">
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="stats cursor-default bg-base-100 shadow">
              <div class="stat">
            ...
            jsx={`<div className="stats cursor-default bg-base-100 shadow">
              <div className="stat">
                <div className="stat-title">Washes this week</div>
                <div className="stat-value">48</div>
                <div className="stat-desc">12 more than last week</div>
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="stats w-full cursor-default bg-base-100 shadow">
              <div class="stat">
                <div class="stat-figure text-primary">
                  <Droplets class="size-8" strokeWidth= aria-hidden />
                </div>
              ...
              <div class="stat">
                <div class="stat-figure text-secondary">
                  <Palette class="size-8" strokeWidth= aria-hidden />
                </div>
            ...
            jsx={`<div className="stats w-full cursor-default bg-base-100 shadow">
              <div className="stat">
                <div className="stat-figure text-primary">
                  <Droplets className="size-8" strokeWidth={2} aria-hidden />
                </div>
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="flex flex-col gap-4">
              ...
              <div class="stats stats-vertical w-full cursor-default bg-base-100 shadow lg:stats-horizontal">
                <div class="stat">
            ...
            html={`<div class="stats w-full cursor-default bg-base-100 shadow">
              ...
              <div class="stat">
                <div class="stat-figure text-success">
                  <TrendingUp class="size-8" strokeWidth= aria-hidden />
                </div>
              ...
              <div class="stats w-full cursor-default border border-ink-border/60 bg-base-100/80 shadow-sm">
                ...
                <div class="stat">
                  <div class="stat-figure text-info">
                    <Clock class="size-8" strokeWidth= aria-hidden />
                  </div>
              ...
              <div class="stats cursor-default border border-base-300 bg-base-100">
                <div class="stat">
                  ...
                  <div class="stat-actions">
                    <button
                      type="button"
                      class="btn btn-xs btn-success cursor-pointer"
                    >
                      Add funds
                    </button>
                  </div>
                ...
                <div class="stat">
                  ...
                  <div class="stat-actions">
                    <button type="button" class="btn btn-xs cursor-pointer">
                      Withdraw
                    </button>
                    <button type="button" class="btn btn-xs cursor-pointer">
                      Deposit
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="stats stats-vertical w-full cursor-default bg-base-100 shadow lg:stats-horizontal">
            ...
            jsx={`<div className="stats stats-vertical w-full cursor-default bg-base-100 shadow lg:stats-horizontal">
              <div className="stat place-items-center lg:place-items-start">
                <div className="stat-title">Downloads</div>
                <div className="stat-value">31K</div>
                <div className="stat-desc">Jan 1 to Feb 1</div>
