...
const CURSOR_MCP_JSON = `{
  "mcpServers": {
    "wash-ui-web": {
      "command": "npx",
      "args": ["-y", "@menzies-mariesta-com/wash-ui-mcp@1.0.6"]
    },
    "wash-compose-android": {
      "command": "npx",
      "args": ["-y", "@menzies-mariesta-com/wash-compose-mcp@1.0.6"]
    }
  }
}`
...
npx -y @menzies-mariesta-com/wash-compose-mcp@1.0.6`}</Code>
      </DocSection>
        ...
        <ShowcaseTabs
          preview={
            <div className="rounded-box border border-ink-border bg-base-200/60 p-4 font-mono text-xs">
              ...
              <p className="mt-2">npx -y @menzies-mariesta-com/wash-ui-mcp@1.0.6</p>
              <p className="mt-1">npx -y @menzies-mariesta-com/wash-compose-mcp@1.0.6</p>
            </div>
          }
