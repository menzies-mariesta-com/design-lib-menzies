      ...
      <div className="space-y-6">
        ...
        >
          <ShowcaseTabs
            ...
            {widths.map((w) => (
              <div key= class="flex flex-col items-start gap-2">
                <button
                  type="button"
                  class="btn cursor-pointer"
                ...
                <dialog id= class="modal">
                  <div class={\`modal-box $\`.trim()}>
                    <h3 class="font-display text-lg font-bold"></h3>
                    <p class="py-4 text-sm text-ink-muted">
                      Width tuned with Tailwind utilities on modal-box.
                    </p>
                    <div class="modal-action">
            ...
            jsx={`<div className="flex flex-wrap gap-3">
            {widths.map((w) => (
              <div key={w.id} className="flex flex-col items-start gap-2">
                <button
                  type="button"
              ...
              <div key= class="flex flex-col items-start gap-2">
                ...
                <dialog id= class=>
                  <div class="modal-box">
                    <h3 class="font-display text-lg font-bold"></h3>
                    <p class="py-4 text-sm text-ink-muted">
                      Anchored with <span class="font-mono text-xs"></span>.
                    </p>
                    <div class="modal-action">
                      <form method="dialog">
                        <button type="submit" class="btn cursor-pointer">
        ...
        >
          ...
          >
            <div class="modal-box">
              ...
              <p class="py-4 text-sm text-ink-muted">
                Visible while <span class="font-mono text-xs">modal-open</span>{' '}
                is applied. Clear the class to dismiss.
              </p>
              <div class="modal-action">
                <button
        ...
        >
          <ShowcaseTabs
            ...
            html={`<div class="flex flex-wrap items-center gap-4">
            <label for="dlg-check" class="btn cursor-pointer">
              Open checkbox modal
            </label>
            <!-- ClassLabel -->
          </div>
          ...
          <div class="modal" role="dialog">
            ...
            <label class="modal-backdrop cursor-pointer" for="dlg-check">
              Close
            </label>
          </div>`}
            jsx={`<div className="flex flex-wrap items-center gap-4">
        ...
        >
          ...
          <div class="modal" id="dlg-popover-backdrop" popover="auto">
            <div class="modal-box">
              <h3 class="font-display text-lg font-bold">Popover backdrop</h3>
              <p class="py-4 text-sm text-ink-muted">
                Click outside via modal-backdrop to hide.
              </p>
            </div>
          ...
          <dialog id="dlg-form" class="modal">
            <div class="modal-box">
              ...
              >
                ...
                <div class="form-control w-full">
                  <label class="label" for="dlg-plate-notes">
            ...
            <div class="modal-box">
              ...
              <div class="modal-action">
                <form method="dialog" class="flex gap-2">
                  ...
                  <button type="submit" class="btn btn-error cursor-pointer">
                    Delete
                  </button>
                </form>
              </div>
        ...
        >
          <ShowcaseTabs
            ...
            html={`<ul class="grid gap-2 sm:grid-cols-2">
            {[
              ['modal', 'Component root'],
              ['modal-box', 'Content panel'],
              ['modal-action', 'Action row'],
              ...
              <li
                key=
                class="flex flex-col gap-0.5 rounded-box border border-ink-border/60 px-3 py-2"
              >
                <!-- ClassLabel -->
            ...
            jsx={`<ul className="grid gap-2 sm:grid-cols-2">
            {[
              ['modal', 'Component root'],
              ['modal-box', 'Content panel'],
              ['modal-action', 'Action row'],
