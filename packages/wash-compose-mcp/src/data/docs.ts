export const installGuide = {
  mavenCoordinates: 'com.mariesta.menzies:menzies-design-wash-compose:1.2.0',
  ...
  gradle: {
    ...
    dependency: `implementation("com.mariesta.menzies:menzies-design-wash-compose:1.2.0")`,
...
Preferred: npx -y @menzies-mariesta-com/wash-compose-mcp@1.2.0
