export const installGuide = {
  mavenCoordinates: 'com.mariesta.menzies:menzies-design-wash-compose:1.1.1',
  ...
  gradle: {
    ...
    dependency: `implementation("com.mariesta.menzies:menzies-design-wash-compose:1.1.1")`,
...
Preferred: npx -y @menzies-mariesta-com/wash-compose-mcp@1.1.1
